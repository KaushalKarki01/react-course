...
console.log(firstGenre, otherGenres);

// SPREAD OPERATOR
//adding a new item in the object/array

// add the property to be updated at the last
// the property overwrites the previous property just for the new book
const updatedBook = {
  ...book,
  adaptedMovieName: "The Lord of the Rings",
  pages: 1298,
};
